...
def create_top_file(module_name,reg_model):
    ...
    top_file.write('        vcdpluson();\n')
    top_file.write('        vcdplusmemon();\n')
    top_file.write('    end\n')
    top_file.write('\n')
    top_file.write('    initial begin\n')
...
'''
    ...
    makefile.write('\tvcs -sverilog +v2k -ntb_opts uvm-1.1 -debug_access+all +plusarg_save $(VCS_HOME)/etc/uvm/src/uvm_macros.svh \\\n')
    ...
    makefile.write('\t+define+UVM_NO_DEPRECATED -vpd_file ./wave/$(case_name)_wave/$(case_name).vpd\n')
